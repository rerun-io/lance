...
mod frag_reuse_remap_mode_tests {
    ...
    /// An unparsable setting must warn and fall back rather than fail an open, since it
    ...
    #[case::unparsable(Some("nonsense"), IndexRemapMode::Direct, false)]
    ...
    #[case::assert_unparsable(Some("assert(nonsense)"), IndexRemapMode::Direct, false)]
